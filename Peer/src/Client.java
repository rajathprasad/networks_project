...
public class Client {
 ...
 // public static ArrayList<RTPpacket> RTPPacketBuffer= new ArrayList<RTPpacket>();
  ...
  //main
  //------------------------------------
  public void start_client(int server_port, InetAddress serverIP, String video) throws Exception
  //public void start_client() throws Exception
  {
	//Create a Client object
	   // Client theClient = new Client();
	    ...
	    //------------------
	    int RTSP_server_port = server_port;
	  ...
	  //  String ServerHost = serverIP;
	   ...
	   // InetAddress ServerIPAddr = InetAddress.getByName("192.168.1.8");
	    InetAddress ServerIPAddr =serverIP;
...
//		}  
//	    
//	      for(RTPpacket rtp: Server.RTPPacketBufferServer)
//	      {
...
//	      }
  ...
  class timerListener implements ActionListener {
	...
	Server.RTPPacketBufferServer.add(rtp_packet);
	//Server.RTPPacketBuffer.add(rtp_packet);
	//print important header fields of the RTP packet received: 
	System.out.println("Got RTP packet with SeqNum # "+rtp_packet.getsequencenumber()+" TimeStamp "+rtp_packet.gettimestamp()+" ms, of type "+rtp_packet.getpayloadtype());
	 System.out.println("From " + rcvdp.getAddress().toString());
